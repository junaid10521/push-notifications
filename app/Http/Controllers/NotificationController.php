...
use App\Notifications\TypeTwoNotification;
...
//        dd($request);
    ...
    public function notificationType2(Request $request){
        $request->user()->notify(new TypeTwoNotification);

        return response()->json('Type two Notification sent.', 201);
    }
